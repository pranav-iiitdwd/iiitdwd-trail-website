function hover1 () {
	...
	document.getElementById("academics").style.backgroundColor= "#143975";
	document.getElementById("academics").style.color= "#FFFFFF";
	}
...
function hover4() {
	...
	function cs_mouseover() {
		document.getElementById("dep-1").style.boxShadow = "5px 5px 15px -5px #A5A5A5";
	}
	function cs_mouseout() {
		document.getElementById("dep-1").style.boxShadow = "0px 0px 0px 0px #FFFFFF";
	}
	document.getElementById("dep-1").addEventListener("mouseover",cs_mouseover);
	document.getElementById("dep-1").addEventListener("mouseout",cs_mouseout);

	function ec_mouseover() {
		document.getElementById("dep-2").style.boxShadow = "5px 5px 15px -5px #A5A5A5";
	}
	function ec_mouseout() {
		document.getElementById("dep-2").style.boxShadow = "0px 0px 0px 0px #FFFFFF";
	}
	document.getElementById("dep-2").addEventListener("mouseover",ec_mouseover);
	document.getElementById("dep-2").addEventListener("mouseout",ec_mouseout);

	document.getElementById("ac-1").style.cursor = "pointer";
	document.getElementById("ac-2").style.cursor = "pointer";
	document.getElementById("ac-3").style.cursor = "pointer";
	document.getElementById("ac-4").style.cursor = "pointer";

	function ac1_mouseover() {
		document.getElementById("ac-1").style.boxShadow = "5px 5px 15px -5px #A5A5A5";
	}
	function ac1_mouseout() {
		document.getElementById("ac-1").style.boxShadow = "0px 0px 0px 0px #FFFFFF";
	}
	document.getElementById("ac-1").addEventListener("mouseover",ac1_mouseover);
	document.getElementById("ac-1").addEventListener("mouseout",ac1_mouseout);

	function ac2_mouseover() {
		document.getElementById("ac-2").style.boxShadow = "5px 5px 15px -5px #A5A5A5";
	}
	function ac2_mouseout() {
		document.getElementById("ac-2").style.boxShadow = "0px 0px 0px 0px #FFFFFF";
	}
	document.getElementById("ac-2").addEventListener("mouseover",ac2_mouseover);
	document.getElementById("ac-2").addEventListener("mouseout",ac2_mouseout);

	function ac3_mouseover() {
		document.getElementById("ac-3").style.boxShadow = "5px 5px 15px -5px #A5A5A5";
	}
	function ac3_mouseout() {
		document.getElementById("ac-3").style.boxShadow = "0px 0px 0px 0px #FFFFFF";
	}
	document.getElementById("ac-3").addEventListener("mouseover",ac3_mouseover);
	document.getElementById("ac-3").addEventListener("mouseout",ac3_mouseout);

	function ac4_mouseover() {
		document.getElementById("ac-4").style.boxShadow = "5px 5px 15px -5px #A5A5A5";
	}
	function ac4_mouseout() {
		document.getElementById("ac-4").style.boxShadow = "0px 0px 0px 0px #FFFFFF";
	}
